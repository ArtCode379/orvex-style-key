...
Project directory: /tmp/orvex-style-key

Task metadata:
- Asana task gid: 1217580748339433
- Asana task name: GB GW4 C1509
- Asana URL: https://app.asana.com/1/1208304498069546/project/1213586227413017/task/1217580748339433
- App name: Orvex Style Key
- Company: ORVEX RETAIL LTD
- Domain: https://orvexretail.surf
...
2. Do not create project-local agent instruction files inside /tmp/orvex-style-key.
